...
abstract class $WalletStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, UserModel? userModel, bool isSubscribed});
...
class _$_WalletState implements _WalletState {
  ...
  @override
  String toString() {
    return 'WalletState(isLoading: $isLoading, userModel: $userModel, isSubscribed: $isSubscribed)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoading, userModel, isSubscribed);
...
abstract class _WalletState implements WalletState {
  const factory _WalletState(
      {final bool isLoading,
      final UserModel? userModel,
      final bool isSubscribed}) = _$_WalletState;
