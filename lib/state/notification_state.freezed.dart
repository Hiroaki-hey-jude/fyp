...
abstract class $NotificationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, List<OrderModel> orders});
}
...
class _$_NotificationState implements _NotificationState {
  const _$_NotificationState(
      {this.isLoading = false, final List<OrderModel> orders = const []})
      : _orders = orders;
  ...
  @override
  String toString() {
    return 'NotificationState(isLoading: $isLoading, orders: $orders)';
  }
...
abstract class _NotificationState implements NotificationState {
  const factory _NotificationState(
      {final bool isLoading,
      final List<OrderModel> orders}) = _$_NotificationState;
